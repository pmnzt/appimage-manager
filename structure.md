...
- example-output: if the directory ~/.appimages doesn't exist it creates it, each appimage file that was found (.AppIamge) gets moved to ~/.appimages each .AppImage file will have its own folder 
